...
$faqs = [
    ...
    "Perché il mio account è associato a un paese?" => [
        ...
        "<ol class='pl-3 -mt-3'>
            <li class='pl-3'>La società consociata Google che offre i servizi, tratta le tue informazioni ed è  responsabile del rispetto delle leggi sulla privacy vigenti. Generalmente Google offre i propri servizi  per i consumatori tramite una delle due società seguenti:
            ...
            <div class="p-0">
                <div class="px-2 pb-1 pt-2">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo c-pointer p-2">
                            <h5 class="d-inline-block">Privacy e termini</h5>
                        </div>
        ...
        <section>
            <div class="container py-2 d-flex justify-content-between">
                <div class="buttons font-weight-light">
                    ...
                    <span class="position-relative point">.</span>
